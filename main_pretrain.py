...
def get_args_parser():
    ...
    parser.add_argument('--use_sigmoid', action='store_true', help='use sigmoid for the final layer ')
    ...
    parser.add_argument('--clip_grad', default=1000.0, type=float,)
...
def main(args):
    ...
    if args.use_3d:
        ...
        if 'mnist'in args.name_dataset :
            ...
            dataset_train = medmnist.build_dataset(data_flag=args.name_dataset, mode='train', transforms = data_transform, size = args.input_size)
        else:
    ...
    if "vim" in args.model :
        ...
        model = models_vim_mae.__dict__[args.model](
                img_size=args.input_size, in_chans = num_channels,
