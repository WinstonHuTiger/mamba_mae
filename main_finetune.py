...
from utils import brats_160, medmnist
...
from engine_finetune import train_one_epoch, evaluate, evaluate_3d
...
def main(args):
    ...
    if args.use_3d:
        ...
        train_transforms2 = tio.Compose([
        tio.RandomAffine(),
        tio.RandomNoise(std=0.1),
        tio.RandomGamma(log_gamma=(-0.3, 0.3))])
        
        train_transforms = tio.OneOf({train_transforms1: 0.3, train_transforms2: 0.7})
        ...
        if 'mnist'in args.name_dataset :
            ...
            target_transform = transforms.Lambda(lambda x: np.squeeze(x))
